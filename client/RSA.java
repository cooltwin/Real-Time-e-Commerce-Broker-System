...
public class RSA {
	...
	public PublicKey readPublicKeyFromFile() throws IOException{
		MiscellaneousWork mw = new MiscellaneousWork();
		try {
			BigInteger modulus =  new BigInteger(mw.read_password_file(webserver_name, "PubKey Modulus"));
			BigInteger exponent = new BigInteger(mw.read_password_file(webserver_name, "PubKey Exponent")); 
